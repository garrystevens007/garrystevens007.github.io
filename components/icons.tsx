...
// lucide-react v1 dropped brand/logo glyphs (GitHub, LinkedIn, etc.) entirely —
// these two small inline SVGs fill that gap without pulling in a whole
// separate brand-icon package for just two marks.
